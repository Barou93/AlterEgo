         ...
         <main className="about">
            <div className="about__header">
               <div className="about__header__text">
                  <h1 className="about__header__text__title">
                     Nous sommes un cabinet de conseil <br /> en Marketing &
                     Expérience client <br />
                     qui fournit des solutions <br />
                     adaptées aux entreprises.
                  </h1>
                  <a href="#btn" className="about__header__text__btn">
                     Contactez-Nous
                  </a>
               </div>
            ...
            <div className="about__teamwork">
               ...
               <div className="about__teamwork__title">
                  <hgroup>
                     <h3 className="about__teamwork__headlines">
                        Qui sommes-nous ?
                     </h3>
                     <h4 className="about__teamwork__text">
                        Notre agence est dédiée à offrir des solutions
                        innovantes <br /> et sur mesure pour répondre à vos
                        besoins spécifiques
                        <br /> en matière de marketing et de gestion de
                        l'expérience client.
                     </h4>
                  </hgroup>
               </div>
               ...
               <div className="about__help__text__container">
                  <hgroup>
                     ...
                     <h4 className="about__help__text__container__smalltitle">
                        Nous sommes passionnés par l'excellence de notre travail
                        et nous nous engageons à offrir un service de qualité
                        supérieure à chaque étape de notre collaboration.
                     </h4>
                  </hgroup>
               </div>
               <div className="about__help__img__container">
                  <figure className="about__help__img__container__box">
                     ...
                     <span className="about__help__img__container__box__title">
                        Nos clients sont au coeur de notre activité, On vous
                        accompagne étape par étape pour étape dans la mise en
                        place d’une stratégie CX.
                     </span>
                  </figure>
                  <figure className="about__help__img__container__box">
                     <img
                     ...
                     <span className="about__help__img__container__box__title">
                        Nous sommes convaincus que la clé du succès réside dans
                        une collaboration étroite et transparente avec nos
                        clients.
                     </span>
                  </figure>
                  <figure className="about__help__img__container__box">
                     ...
                     <span className="about__help__img__container__box__title">
                        Nous veillons toujours à ce que notre tâche soit remise
                        dans le délai imparti. Notre principale priorité est la
            ...
            <div className="about__whyus">
               <div className="about__help__text__container">
                  ...
                  <span className="about__help__text__container__smalltitle">
                     Voici quelques raisons pour lesquelles les clients
                     choisissent AlterEgo plutôt qu'un concurrent
                  </span>
               </div>
               <div className="about__help__img__container ">
                  <figure className="about__help__img__container__box whyus__img__box">
                     ...
                     <span className="about__help__img__container__box__title">
                        ...
                        l'expérience utilisateur et le marketing. Nous
                        apporterons de la valeur à votre exploitation
                        commerciale tout en garantissant
                     </span>
                  </figure>
               ...
               <div className="about__founder__quote">
                  <div className="about__founder__quote__text__container">
                     ...
                     <p className="about__founder__quote__title">
                        Notre expertise vous aide à mieux appréhender <br /> les
                        enjeux de l'expérience client et d'investir <br /> dans
                        la qualité de la relation que vous construisez <br />{" "}
                        avec vos clients grâce à une stratégie taillée <br />{" "}
                        sur mesure et traduite en véritable culture d'entreprise
                     </p>
                  </div>
